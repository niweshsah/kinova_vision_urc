...
class YOLOv8ROSNode:
    ...
    def image_callback(self, msg):
        try:
            ...
            results = self.model(cv_image)[0]  # Run inference
            ...
            if self.depth_image is not None:
                ...
                for box in results.boxes:
                    ...
                    self.draw_detections(rendered_image, depth_vis, (x1, y1, x2, y2), center_rgb, depth_value, x, y, z)
    ...
    def draw_detections(self, rgb_img, depth_img, bbox, center_rgb, depth, x, y, z):
