        ...
        try:
            ...
            for result in results:
                ...
                for box in boxes:
                    ...
                    # Use project_rgb_to_depth to get the corresponding depth camera coordinates
                    ...
                    if center_x_depth != -1 and center_y_depth != -1:  # Valid depth data
                    ...
                    if center_x_depth != -1 and center_y_depth != -1:  # Only add depth info if valid
